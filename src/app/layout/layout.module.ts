...
@NgModule({
  declarations: [BlankLayoutComponent, NotFoundComponent, TopbarLayoutComponent, NavbarComponent, FooterComponent, DashboardLayoutComponent, ToolbarComponent, SidebarComponent, PageHeaderComponent],
  imports: [
    CommonModule,
    SharedModule,
    RouterModule
